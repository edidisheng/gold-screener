...
gold_price = yf.download('GC=F', start = '2025-10-01', auto_adjust=True)['Close'].squeeze()
AUD_USDconversion = yf.download('AUDUSD=X', start = '2025-10-01', auto_adjust=True)['Close'].squeeze()
##['Close'].squeeze() 
